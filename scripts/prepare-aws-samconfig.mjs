...
const replacements = [
  ...
  ['GoogleDriveClientId', getOptionalEnv('VITE_GOOGLE_DRIVE_CLIENT_ID')],
  ['GoogleDriveClientSecret', getOptionalEnv('VITE_GOOGLE_DRIVE_CLIENT_SECRET')],
  ['GoogleDriveRefreshToken', getOptionalEnv('VITE_GOOGLE_DRIVE_REFRESH_TOKEN')],
  ['GoogleDriveImageArchiveRootFolderId', getOptionalEnv('VITE_GOOGLE_DRIVE_IMAGE_ARCHIVE_ROOT_FOLDER_ID')],
