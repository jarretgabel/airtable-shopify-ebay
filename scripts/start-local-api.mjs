...
function setAwsEnv() {
  ...
  process.env.AIRTABLE_SHOPIFY_VENDORS_TABLE_REF =
    getOptionalEnv(mergedEnv, 'VITE_AIRTABLE_SHOPIFY_VENDORS_TABLE_REF')
    || 'apprsAm2FOohEmL2u/tblF0B5TUhy20hJCv/viwx2RONDo3Ii85Gl';
  process.env.AIRTABLE_SHOPIFY_VENDORS_TABLE_NAME =
    getOptionalEnv(mergedEnv, 'VITE_AIRTABLE_SHOPIFY_VENDORS_TABLE_NAME')
    || 'tblF0B5TUhy20hJCv';
