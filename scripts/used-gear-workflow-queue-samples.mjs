...
function buildSampleRecords() {
  return [
    ...
    {
      label: 'Trash Review Group Companion',
      title: 'Trash Review Group Companion',
      description: 'Second unqualified sample row sharing the same submission group for grouped trash-review testing.',
      make: 'Pioneer',
      model: 'CT-F9191 Rejected Companion',
      componentType: 'Cassette Deck',
      workflowStatus: 'Unqualified',
      qualificationComplete: true,
      qualificationNotes: 'Grouped companion rejected during intake review.',
      offerAmount: 95,
      paidAmount: 0,
    ...
    },
    {
      ...
      description: 'Testing-stage sample row that still needs testing signoff before photography can begin.',
      make: 'Sansui',
    ...
    },
    {
      ...
      description: 'Photography-stage sample row with testing complete and photography still pending.',
      make: 'Nakamichi',
      model: 'BX-300 Photo Pending',
      componentType: 'Cassette Deck',
      workflowStatus: 'Photography In Progress',
      qualificationComplete: true,
