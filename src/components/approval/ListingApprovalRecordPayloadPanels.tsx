    ...
    <>
        ...
        <div className={detailDisclosureBodyClass}>
          ...
          {shopifyCategorySyncPreviewJson && (
            <>
              ...
              <pre className={detailPreBlockClass}>{shopifyCategorySyncPreviewJson}</pre>
            </>
          )}
        </div>
      </details>
      ...
      <details className={`mt-4 ${detailDisclosureClass}`}>
        ...
        <div className={detailDisclosureBodyClass}>
          ...
          <pre className={detailPreBlockClass}>{SHOPIFY_CREATE_PAYLOAD_DOCS_JSON}</pre>
        </div>
      </details>
    </>
  );
    ...
    <>
      ...
      <details className={`mt-4 ${detailDisclosureClass}`}>
        ...
        <div className={detailDisclosureBodyClass}>
          ...
          <pre className={detailPreBlockClass}>{EBAY_PAYLOAD_DOCS_JSON}</pre>
        </div>
      </details>
    </>
  );
