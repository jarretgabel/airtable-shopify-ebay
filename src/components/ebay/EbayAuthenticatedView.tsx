    ...
    <div className="flex flex-col gap-5 py-1">
      ...
      <div className="rounded-[14px] border border-[var(--line)] bg-[var(--panel)] px-4 py-4 shadow-[0_10px_24px_rgba(15,23,42,0.04)]">
        ...
        <div className="grid grid-cols-3 gap-3.5 max-[960px]:grid-cols-2 max-[600px]:grid-cols-1">
          <label className="flex flex-col gap-1.5 text-[0.8rem] font-semibold text-[var(--ink)]">Location key<input className={runameInputClass} type="text" value={locationConfig.key} onChange={(event) => setLocationConfig((current: EbayLocationConfig) => ({ ...current, key: event.target.value }))} spellCheck={false} /></label>
          <label className="flex flex-col gap-1.5 text-[0.8rem] font-semibold text-[var(--ink)]">Location name<input className={runameInputClass} type="text" value={locationConfig.name} onChange={(event) => setLocationConfig((current: EbayLocationConfig) => ({ ...current, name: event.target.value }))} spellCheck={false} /></label>
          <label className="flex flex-col gap-1.5 text-[0.8rem] font-semibold text-[var(--ink)]">Country<input className={runameInputClass} type="text" value={locationConfig.country} onChange={(event) => setLocationConfig((current: EbayLocationConfig) => ({ ...current, country: event.target.value.toUpperCase() }))} spellCheck={false} /></label>
          <label className="flex flex-col gap-1.5 text-[0.8rem] font-semibold text-[var(--ink)]">Postal code<input className={runameInputClass} type="text" value={locationConfig.postalCode} onChange={(event) => setLocationConfig((current: EbayLocationConfig) => ({ ...current, postalCode: event.target.value }))} spellCheck={false} /></label>
          <label className="flex flex-col gap-1.5 text-[0.8rem] font-semibold text-[var(--ink)]">City<input className={runameInputClass} type="text" value={locationConfig.city} onChange={(event) => setLocationConfig((current: EbayLocationConfig) => ({ ...current, city: event.target.value }))} spellCheck={false} /></label>
          <label className="flex flex-col gap-1.5 text-[0.8rem] font-semibold text-[var(--ink)]">State / province<input className={runameInputClass} type="text" value={locationConfig.stateOrProvince} onChange={(event) => setLocationConfig((current: EbayLocationConfig) => ({ ...current, stateOrProvince: event.target.value }))} spellCheck={false} /></label>
          <label className="flex flex-col gap-1.5 text-[0.8rem] font-semibold text-[var(--ink)]">Fulfillment policy ID<input className={runameInputClass} type="text" value={policyConfig.fulfillmentPolicyId} onChange={(event) => setPolicyConfig((current: EbayBusinessPolicyConfig) => ({ ...current, fulfillmentPolicyId: event.target.value }))} spellCheck={false} /></label>
