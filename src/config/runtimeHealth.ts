...
export function getRuntimeHealthReport(): RuntimeHealthReport {
  return {
    ...
    entries: [
      ...
      createEntry('Approval Airtable table', 'optional', ['VITE_AIRTABLE_APPROVAL_TABLE_REF', 'VITE_AIRTABLE_APPROVAL_TABLE_NAME'], 'Used for eBay-ready listing review records that feed the Listings workflow.'),
      createEntry('Shopify approval Airtable table', 'optional', ['VITE_AIRTABLE_SHOPIFY_APPROVAL_TABLE_REF', 'VITE_AIRTABLE_SHOPIFY_APPROVAL_TABLE_NAME'], 'Used for Shopify-ready listing review records that feed the Listings workflow.'),
      createEntry('Combined listings Airtable table', 'optional', ['VITE_AIRTABLE_COMBINED_LISTINGS_TABLE_REF', 'VITE_AIRTABLE_COMBINED_LISTINGS_TABLE_NAME'], 'Used for the combined Listings review workflow.'),
