...
interface ImportMetaEnv {
  ...
  readonly VITE_USE_LAMBDA_AIRTABLE?: string;
  readonly VITE_USE_LAMBDA_AI?: string;
  readonly VITE_USE_LAMBDA_GMAIL?: string;
  readonly VITE_USE_LAMBDA_SHOPIFY?: string;
  ...
  readonly VITE_USE_LAMBDA_JOTFORM?: string;
